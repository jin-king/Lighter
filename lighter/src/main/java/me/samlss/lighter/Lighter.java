...
public class Lighter implements LighterInternalAction {
    ...
    public Lighter setOnLighterInterceptClickListener(OnLighterViewInterceptClickListener listener) {
        mInternalImpl.setOnLighterInterceptClickListener(listener);
        return this;
    }
